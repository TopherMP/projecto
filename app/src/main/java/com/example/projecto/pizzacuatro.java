...
public class pizzacuatro extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pizzacuatro);
        ...
        rBar.setOnRatingBarChangeListener(new RatingBar.OnRatingBarChangeListener() {
            ...
            public void onRatingChanged(RatingBar ratingBar, float v, boolean b) {
                Toast.makeText(pizzacuatro.this,"Usted calificó con: "+v,Toast.LENGTH_SHORT).show();
            }
        });
        ...
        elem = new ArrayList<>();
        elem.add(new list_Elements(R.drawable.p4,"Pizza 4","Piña, Tomate, Carne mechada, Pollo","$14.000"));elem.add(new list_Elements(R.drawable.p4,"Pizza 4","Piña, Tomate, Carne mechada, Pollo","$14.000"));
