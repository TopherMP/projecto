...
public class pizzatres extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pizzatres);
        ...
        rBar.setOnRatingBarChangeListener(new RatingBar.OnRatingBarChangeListener() {
            ...
            public void onRatingChanged(RatingBar ratingBar, float v, boolean b) {
                Toast.makeText(pizzatres.this,"Usted calificó con: "+v,Toast.LENGTH_SHORT).show();
            }
        });
        ...
        elem = new ArrayList<>();
        elem.add(new list_Elements(R.drawable.p3,"Pizza 3","Pepperoni, Jamón, Queso, Pimiento verde","$10.000"));elem.add(new list_Elements(R.drawable.p3,"Pizza 3","Pepperoni, Jamón, Queso, Pimiento verde","$10.000"));
